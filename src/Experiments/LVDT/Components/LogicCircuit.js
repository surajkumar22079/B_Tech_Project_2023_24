    ...
    if (!diagramInstance.current) {
      ...
      if (connectors.length === 0) {
        ...
        for (let i = 0; i < connectors.length; i++) {
          ...
          if (
            !(
              (sourcePort === "VLVDT_port1" && targetPort === "imgrev_port1") ||
              (sourcePort === "imgrev_port1" && targetPort === "VLVDT_port1") ||
              (sourcePort === "VLVDT_port2" && targetPort === "imgrev_port2") ||
              (sourcePort === "imgrev_port2" && targetPort === "VLVDT_port2") ||
